...
(function(window, document, $) {
    'use strict';
     $('.page1-links').twbsPagination({
        ...
        onPageClick: function (event, page) {
            $('#page1-content').text('شما در صفحه ' + page);
    ...
    $('.page2-links').twbsPagination({
        ...
        last: null,
        onPageClick: function (event, page) {
            $('#page2-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    ...
    $('.page3-links').twbsPagination({
        ...
        last: null,
        onPageClick: function (event, page) {
            $('#page3-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    $('.firstLast1-links').twbsPagination({
        ...
        last: 'آخرین',
        onPageClick: function (event, page) {
            $('#firstLast1-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    ...
    $('.firstLast2-links').twbsPagination({
        ...
        last: 'آخرین',
        onPageClick: function (event, page) {
            $('#firstLast2-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    ...
    $('.firstLast3-links').twbsPagination({
        ...
        last: 'آخرین',
        onPageClick: function (event, page) {
            $('#firstLast3-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    ...
    $('.start-links').twbsPagination({
        ...
        last: 'آخرین',
        onPageClick: function (event, page) {
            $('#start-content').text('صفحه شروع شما ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    $('.loop-links').twbsPagination({
        ...
        loop: true,
        onPageClick: function (event, page) {
            $('#loop-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    $('.url-links').twbsPagination({
        ...
        href: '?page={{page}}',
        onPageClick: function (event, page) {
            $('#url-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    $('.url1-links').twbsPagination({
        ...
        hrefVariable: '{{page}}',
        onPageClick: function (event, page) {
            $('#url1-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
    $('.synchronized-links').twbsPagination({
        ...
        last: 'آخرین',
        onPageClick: function (event, page) {
            $('#synchronized-content').text('شما در صفحه ' + page);
            $(".pagination").find('li').addClass('page-item');
            $(".pagination").find('a').addClass("page-link");
        }
    });
