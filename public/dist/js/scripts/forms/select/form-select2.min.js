! function (e, t, c) {
    ...
    c(".select2").select2(), c(".select2-placeholder").select2({
        ...
        placeholder: "یک حالت را انتخاب کنید"
    }), c(".select2-placeholder-colors").select2({
        placeholder: "حداقل یک رنگ را انتخاب کنید"
    }), c(".hide-search").select2({
        minimumResultsForSearch: 1 / 0
    }), c(".max-length").select2({
        maximumSelectionLength: 2,
        placeholder: "حداکثر 2 مورد را انتخاب کنید"
    });
    var s = c(".js-example-events");
    s.select2({
        placeholder: "رویدادهای DOM"
    ...
    r.select2({
        placeholder: "رویدادهای برنامه نویسی"
    ...
    c(".select2-data-array").select2({
        ...
        placeholder: "بارگیری داده های راه دور",
        ajax: {
