...
$(document).ready(function(){
	...
	************************************/
    ...
    $('.block-default-message').on('click', function() {
        var block_ele = $(this).closest('.card');
        $(block_ele).block({
            message: '<span class="semibold"> بارگذاری...</span>',
            timeout: 2000, //unblock after 2 seconds
            overlayCSS: {
                backgroundColor: '#fff',
                opacity: 0.8,
    ...
    $('.block-msg-animation').on('click', function() {
        var block_ele = $(this).closest('.card');
        $(block_ele).block({
			message: '<div class="semibold"><span class="ft-refresh-cw icon-spin text-left"></span>&nbsp; بارگذاری ...</div>',
            fadeIn: 1000,
            fadeOut: 1000,
			timeout: 2000, //unblock after 2 seconds
            overlayCSS: {
    ...
    $('.block-multiple-msgs').on('click', function() {
        ...
        window.setTimeout(function () {
			message.html('<div class="semibold"><span class="ft-refresh-cw icon-spin text-left"></span>&nbsp; بارگذاری ...</div>');
        }, 0);

        window.setTimeout(function () {
			message.html('<div class="semibold">کمی صبر کنید...</div>');
        }, 2000);

        window.setTimeout(function () {
			message.addClass('bg-success').html('<div class="semibold"><span class="icon-thumbs-o-up text-left"></span>&nbsp; موفقیت آمیز</div>');
        }, 4000);
